...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: packageJson.version, items: [
        { text: "Repository", link: "https://github.com/OGS-GmbH/use-axios" },
        { text: "Changelog", link: "https://github.com/OGS-GmbH/use-axios/blob/main/CHANGELOG.md" },
  ...
  outDir: "../dist/docs",
  titleTemplate: ":title - OGS useAxios",
  cleanUrls: true,
  appearance: true,
  markdown: {
    config(md) {
